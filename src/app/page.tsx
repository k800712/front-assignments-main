            ...
            <div className="relative z-10 w-full bg-white/90 backdrop-blur-sm shadow-lg mt-auto">
                <div className="max-w-4xl mx-auto p-3">
                    ...
                    <div className="flex items-center justify-between mb-3">
                        <h2 className="text-sm font-bold text-gray-800">고객센터</h2>
                        <Link
                            href="/chat"
                            className="bg-purple-600 hover:bg-purple-700 text-white px-4 py-1 rounded-full text-xs transition-colors duration-200 flex items-center gap-2"
                        >
